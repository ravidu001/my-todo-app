...
const Signup = ({ onSwitchToLogin }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (result.success) {
      // Signup successful - user will be redirected by App.jsx
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`block w-full pl-10 pr-3 py-3 border rounded-xl text-secondary-900 placeholder-secondary-500 focus:outline-none focus:ring-2 focus:border-transparent transition-all duration-200 bg-secondary-50 focus:bg-white ${
                      formErrors.username 
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`block w-full pl-10 pr-12 py-3 border rounded-xl text-secondary-900 placeholder-secondary-500 focus:outline-none focus:ring-2 focus:border-transparent transition-all duration-200 bg-secondary-50 focus:bg-white ${
                      formErrors.password 
                        ? 'border-error-300 focus:ring-error-500' 
                        : 'border-secondary-300 focus:ring-primary-500'
                    }`}
